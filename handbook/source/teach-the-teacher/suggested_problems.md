...
This section presents a set of **problem-based learning (PBL) modules** that correspond to the stages of the open-source digital IC design flow. Each module focuses on a concrete design problem, encouraging participants to **explore**, **experiment**, and **apply** concepts introduced in the *Concepts* and *Course Structure* sections.
